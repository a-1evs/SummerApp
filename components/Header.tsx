...
const Header = () => {
    ...
    if (pathname.startsWith("/displayPrint")) {
        return <div className={"m-4"}>
            <img src={"https://www.summertech.net/wp-content/uploads/2020/02/g8.png"}/>
            <h1 className={"text-2xl mt-2"}>SummerTech Events</h1>
        </div>
    }

    return (
        <header
            className="fixed top-0 left-0 right-0 bg-gray-800 text-white p-6 flex justify-between items-center z-50">
            <div className="flex items-center">
                <div className="mr-4 flex-shrink-0">
                    <Image src="/images/logo.png" alt="Camp Logo" width={78 * sizeFactor} height={64 * sizeFactor}
                           className="h-16"/>
                </div>
                <div>
